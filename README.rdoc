...
Disclaimer: this is an incomplete project as it stands right now.  Only three copies work: file to file, s3 to file, and file to s3.  Still to be implemented: file to http, http to file, s3 to http, http to s3.
...
I have checked in a binstubs directory (./bin).  I will eventually remove it, but you can recreate it with:

bundle --binstubs

The rubymine project is checked in too and should be removed too.
